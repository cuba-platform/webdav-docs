...
- https://github.com/cuba-platform/cuba/issues/3307[Update dependencies]
...
- WD-779 https://youtrack.cuba-platform.com/issue/WD-779[Deadlock for MSSQL during select inside beforeInsert ]
